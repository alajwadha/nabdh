...
export type Prayer = { key: PrayerKey; label: string; time: string }; // time = "HH:MM" 24h

export const PRAYERS: Prayer[] = [
  { key: 'fajr', label: 'Fajr', time: '04:12' },
  { key: 'dhuhr', label: 'Dhuhr', time: '11:54' },
  { key: 'asr', label: 'Asr', time: '15:18' },
  { key: 'maghrib', label: 'Maghrib', time: '18:42' },
  { key: 'isha', label: 'Isha', time: '20:12' },
];
